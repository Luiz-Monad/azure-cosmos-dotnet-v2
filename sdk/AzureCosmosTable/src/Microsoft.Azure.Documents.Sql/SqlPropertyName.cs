...
namespace Microsoft.Azure.Documents.Sql
{
	internal sealed class SqlPropertyName : SqlObject
	{
			...
			: base(SqlObjectKind.PropertyName)
		{
			...
			{
				throw new ArgumentException(string.Format("{0} must not be null, empty, or whitespace.", "value"));
			}
			Value = value;
		}
		...
		{
			if (!SystemProperties.TryGetValue(value, out SqlPropertyName value2))
			{
				return new SqlPropertyName(value);
			}
			return value2;
		}
