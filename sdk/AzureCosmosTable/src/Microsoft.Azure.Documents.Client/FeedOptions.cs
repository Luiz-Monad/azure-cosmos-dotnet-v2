...
namespace Microsoft.Azure.Documents.Client
{
	...
	public sealed class FeedOptions
	{
		...
		/// </value>
		internal bool? EmitVerboseTracesInQuery
		{
			get;
			set;
		}
		...
		/// </value>
		internal string FilterBySchemaResourceId
		{
			get;
			set;
		}
		...
		/// </para>
		/// </remarks>
		public bool PopulateQueryMetrics
		{
			get;
			set;
		}
		...
		/// </code>
		/// </example>
		/// <seealso cref="P:Microsoft.Azure.Documents.Client.FeedOptions.ConsistencyLevel" />
		...
		/// </summary>
		internal EnumerationDirection? EnumerationDirection
		{
			get;
			set;
		}
		...
		/// To be used along with Read feed operation
		/// </summary>
		internal ReadFeedKeyType? ReadFeedKeyType
		{
			get;
			set;
		}
		...
		/// </remarks>
		internal ContentSerializationFormat? ContentSerializationFormat
		{
			get;
			set;
		}
		...
		/// </summary>
		internal bool EnableCrossPartitionSkipTake
		{
			get;
			set;
		}
		...
		/// <summary>
		/// Gets or sets the flag that enables group by across partitions.
		/// </summary>
		internal bool EnableCrossPartitionGroupBy
		{
			get;
			set;
		}
		...
		internal FeedOptions(FeedOptions options)
		{
			...
			PartitionKeyRangeId = options.PartitionKeyRangeId;
			...
			{
				PartitionKey = PartitionKey.FromInternalKey(options.PartitionKey.InternalKey);
			}
			EmitVerboseTracesInQuery = options.EmitVerboseTracesInQuery;
			FilterBySchemaResourceId = options.FilterBySchemaResourceId;
			RequestContinuation = options.RequestContinuation;
			ConsistencyLevel = options.ConsistencyLevel;
			JsonSerializerSettings = options.JsonSerializerSettings;
			ForceQueryScan = options.ForceQueryScan;
			EnumerationDirection = options.EnumerationDirection;
			ReadFeedKeyType = options.ReadFeedKeyType;
			StartId = options.StartId;
			EndId = options.EndId;
			StartEpk = options.StartEpk;
			EndEpk = options.EndEpk;
			ContentSerializationFormat = options.ContentSerializationFormat;
			EnableCrossPartitionSkipTake = options.EnableCrossPartitionSkipTake;
			EnableCrossPartitionGroupBy = options.EnableCrossPartitionGroupBy;
			MergeStaticId = options.MergeStaticId;
		}
	}
}
