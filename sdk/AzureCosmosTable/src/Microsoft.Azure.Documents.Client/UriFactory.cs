...
namespace Microsoft.Azure.Documents.Client
{
	...
	public static class UriFactory
	{
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}", "dbs", Uri.EscapeUriString(databaseId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}", "dbs", Uri.EscapeUriString(databaseId), "users", Uri.EscapeUriString(userId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}", "dbs", Uri.EscapeUriString(databaseId), "udts", Uri.EscapeUriString(userDefinedTypeId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "docs", Uri.EscapeUriString(documentId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "users", Uri.EscapeUriString(userId), "permissions", Uri.EscapeUriString(permissionId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "sprocs", Uri.EscapeUriString(storedProcedureId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}", documentCollectionLink, "sprocs", Uri.EscapeUriString(storedProcedureId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "triggers", Uri.EscapeUriString(triggerId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "udfs", Uri.EscapeUriString(udfId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "conflicts", Uri.EscapeUriString(conflictId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}/{6}/{7}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "docs", Uri.EscapeUriString(documentId), "attachments", Uri.EscapeUriString(attachmentId)), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "pkranges"), UriKind.Relative);
		}
		...
		{
			return new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/{1}/{2}/{3}/{4}/{5}", "dbs", Uri.EscapeUriString(databaseId), "colls", Uri.EscapeUriString(collectionId), "schemas", Uri.EscapeUriString(schemaId)), UriKind.Relative);
		}
	}
}
