...
namespace Microsoft.Azure.Documents.Common
{
	internal interface IAddressCache
	{
		...
		Task<PartitionAddressInformation> TryGetAddresses(DocumentServiceRequest request, PartitionKeyRangeIdentity partitionKeyRangeIdentity, ServiceIdentity serviceIdentity, bool forceRefreshPartitionAddresses, CancellationToken cancellationToken);
	}
}
