namespace Microsoft.Azure.Documents.Query.ParallelQuery
{
	...
	internal sealed class ParallelQueryConfig
	{
		...
		private ParallelQueryConfig(int clientInternalMaxItemCount, int defaultMaximumBufferSize, int clientInternalPageSize, int autoModeTasksIncrementFactor, int numberOfNetworkCallsPerProcessor)
		{
