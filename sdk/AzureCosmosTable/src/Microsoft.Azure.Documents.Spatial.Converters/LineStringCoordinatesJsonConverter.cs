...
namespace Microsoft.Azure.Documents.Spatial.Converters
{
	...
	internal sealed class LineStringCoordinatesJsonConverter : JsonConverter
	{
		...
		{
			LineStringCoordinates lineStringCoordinates = (LineStringCoordinates)value;
			serializer.Serialize(writer, lineStringCoordinates.Positions);
		}
		...
		{
			return new LineStringCoordinates(serializer.Deserialize<Position[]>(reader));
		}
